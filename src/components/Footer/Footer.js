...
const footers = [
    ...
    {
        title: 'MIT License',
        link: 'https://github.com/UBC-CIC/UBCO-StudentEngagementApp/blob/main/LICENSE'
    },
    {
        title: 'Attribution',
        link: 'https://github.com/UBC-CIC/UBCO-StudentEngagementApp/blob/main/ATTRIBUTIONS'
    }
];
